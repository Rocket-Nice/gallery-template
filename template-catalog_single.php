                ...
                <div class="catalog-single__content">
                    <div class="side">
                        <div class="catalog-single-contacts">
                            <a href="#" class="catalog-single-contacts__item">
                            ...
                            <div class="catalog-single-social">
                                ...
                                <a href="#" class="catalog-single-social__item vk">
                ...
                <div class="catalog-single-modal">
                    ...
                    <div class="catalog-single-modal__inner">
                        <div class="catalog-single-modal__item">
                            <div class="catalog-single-modal__head">НОМЕР МАГАЗИНА</div>
                            <a href="#" class="catalog-single-modal__link">+7 (929) 939 95 62</a>
                        </div>
                        <div class="catalog-single-modal__item">
                            <div class="catalog-single-modal__head">ОБЩИЙ НОМЕР</div>
                            <a href="#" class="catalog-single-modal__link">+7 (948) 204 22 92</a>
                        </div>
                    </div>
                    <div class="catalog-single-modal__item">
                        <div class="catalog-single-modal__head">ТЕХ. ПОДДЕРЖКА</div>
                        <a href="#" class="catalog-single-modal__link">+7 (562) 958 22 12</a>
                    </div>
                </div>
            </div>
        </div>
