                    ...
                    <div class="catalog__content">
                        ...
                        <div class="catalog-cards">
                            <a href="#" class="catalog-block">
                                <img src="<?php bloginfo('template_url'); ?>/assets/icons/catalog-card-1.svg" loading="lazy" decoding= "async" alt="">
                                <div class="catalog-block__title">Одежда</div>
                            </a>
                            <a href="#" class="catalog-block">
                                <img src="<?php bloginfo('template_url'); ?>/assets/icons/catalog-card-2.svg" loading="lazy" decoding= "async" alt="">
                                <div class="catalog-block__title">Подарки<br>и аксессуары</div>
                            </a>
                            <a href="#" class="catalog-block">
                                <img src="<?php bloginfo('template_url'); ?>/assets/icons/catalog-card-3.svg" loading="lazy" decoding= "async" alt="">
                                <div class="catalog-block__title">Красота<br>и здоровье</div>
                            </a>
                            <a href="#" class="catalog-block">
                                <img src="<?php bloginfo('template_url'); ?>/assets/icons/catalog-card-4.svg" loading="lazy" decoding= "async" alt="">
                                <div class="catalog-block__title">Электроника<br>и бытовая техника</div>
                            </a>
                            <a href="#" class="catalog-block">
                                <img src="<?php bloginfo('template_url'); ?>/assets/icons/catalog-card-5.svg" loading="lazy" decoding= "async" alt="">
                                <div class="catalog-block__title">Детские товары</div>
                            </a>
                            <a href="#" class="catalog-block">
                                <img src="<?php bloginfo('template_url'); ?>/assets/icons/catalog-card-6.svg" loading="lazy" decoding= "async" alt="">
                                <div class="catalog-block__title">Продукты питания<br>и напитки</div>
                            </a>
                        </div>
                    </div>
                </div>
